<?php
	...
	if($i>=3)
	{
		echo "Sorry, already reached the limit of 3 books!!";
		echo "<br><br><button type='button' onclick=home();>Go Back to main page";
	}
	else
	{
		$sql1 = "INSERT INTO book_loans(loan_id,isbn,card_id,date_out,due_date,date_in) VALUES ('$idno','$parts[0]','$x',CURDATE(),DATE_ADD(CURDATE(),INTERVAL 14 DAY),null)";
